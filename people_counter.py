...
ap.add_argument("-k", "--enable-kmeans", type=bool, default=False,
	help="enable kmeans calculations")
...
while True:
	...
	#region k means
	if not args.get("enable-kmeans", True):
		km = kmeans(X, centroid, cv2, frame)
		km.calculate()
